const btn_soma = document.querySelector("#btn_adc")
const btn_subtracao = document.querySelector("#btn_sub")
const btn_multiplicacao = document.querySelector("#btn_mult")
const btn_divisao = document.querySelector("#btn_div")
